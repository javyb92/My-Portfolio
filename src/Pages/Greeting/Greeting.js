        ...
        <header className="jumbotron jumbotron-fluid col-12" id="greeting">   
            <div className="greeting-text">
                ...
                <div className="social-media">
                    <a href="https://github.com/javyb92" class="greeting-link">
                        <i className="fab fa-github-square greeting-icon"></i>
                    </a>
                    <a href="https://www.linkedin.com/in/javierabarragan92/" class="greeting-link">
                        <i className="fab fa-linkedin greeting-icon"></i>
                    </a>
                    <a href="https://www.instagram.com/_j.a.barragan_/" class="greeting-link">
                        <i class="fab fa-instagram greeting-icon"></i>
                    </a>
                </div>
            </div>
        </header>
